...
- 缺少先例：没有明确的参考案例可以遵循
- **应用层+基础设施层混合变更**：这是最常见的误判场景，必须严格按照判定流程检查
...
**For detailed 4-step judgment flow**: See [references/DEPENDENCY_CRITERIA.md#应用层-基础设施层的判定流程](references/DEPENDENCY_CRITERIA.md#应用层-基础设施层的判定流程)
